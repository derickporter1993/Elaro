...
export default class ComplianceGraphViewer extends LightningElement {
    ...
    get statsForDisplay() {
        ...
        return [
            ...
            { label: 'Frameworks', value: this.stats.totalFrameworks || 0, icon: 'utility:bundle_policy' },
            { label: 'Entities', value: this.stats.totalEntities || 0, icon: 'utility:component_customization' }
        ];
    }
