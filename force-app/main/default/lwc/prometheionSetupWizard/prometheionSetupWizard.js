...
export default class PrometheionSetupWizard extends NavigationMixin(LightningElement) {
  @track currentStep = "1";
  ...
  async handleCompleteSetup() {
    ...
    try {
      ...
      this.showToast("Success", "Prometheion setup completed successfully!", "success");
    } catch (error) {
