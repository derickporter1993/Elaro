...
const FRAMEWORKS = [
    ...
    { value: 'SOC2', label: 'SOC 2', icon: 'custom:custom51', description: 'System and Organization Controls 2' },
    { value: 'GDPR', label: 'GDPR', icon: 'custom:custom52', description: 'General Data Protection Regulation' },
    { value: 'FINRA', label: 'FINRA', icon: 'custom:custom53', description: 'Financial Industry Regulatory Authority' },
    { value: 'NIST', label: 'NIST CSF', icon: 'custom:custom54', description: 'NIST Cybersecurity Framework' },
    { value: 'FedRAMP', label: 'FedRAMP', icon: 'custom:custom55', description: 'Federal Risk and Authorization Management Program' },
    { value: 'PCI_DSS', label: 'PCI DSS', icon: 'custom:custom56', description: 'Payment Card Industry Data Security Standard' },
    { value: 'ISO27001', label: 'ISO 27001', icon: 'custom:custom57', description: 'Information Security Management' }
];
...
export default class PrometheionAuditWizard extends NavigationMixin(LightningElement) {
    ...
    loadControlsForFramework() {
        ...
        const controlsByFramework = {
            'HIPAA': [
                { id: '1', code: '164.308', name: 'Administrative Safeguards', status: 'Compliant', selected: true },
                { id: '2', code: '164.310', name: 'Physical Safeguards', status: 'Compliant', selected: true },
                { id: '3', code: '164.312', name: 'Technical Safeguards', status: 'At Risk', selected: true },
                { id: '4', code: '164.314', name: 'Organizational Requirements', status: 'Compliant', selected: true },
                { id: '5', code: '164.316', name: 'Documentation Requirements', status: 'Compliant', selected: true }
            ],
            'SOC2': [
                { id: '1', code: 'CC6.1', name: 'Logical Access Controls', status: 'Compliant', selected: true },
                { id: '2', code: 'CC6.6', name: 'System Boundary Protection', status: 'Compliant', selected: true },
                { id: '3', code: 'CC7.1', name: 'Threat Detection', status: 'At Risk', selected: true },
                { id: '4', code: 'CC7.2', name: 'Security Monitoring', status: 'Compliant', selected: true },
            ...
            'GDPR': [
                { id: '1', code: 'Art.5', name: 'Data Processing Principles', status: 'Compliant', selected: true },
                ...
                { id: '4', code: 'Art.25', name: 'Data Protection by Design', status: 'Compliant', selected: true },
                { id: '5', code: 'Art.33', name: 'Breach Notification', status: 'Compliant', selected: true }
            ],
            'FINRA': [
