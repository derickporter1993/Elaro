/**
 * Jest tests for elaroCopilot LWC component
 *
 * Tests cover:
 * - Component rendering
 * - Chat functionality
...
import ElaroCopilot from "c/elaroCopilot";
...
describe("c-elaro-copilot", () => {
  ...
  async function createComponent() {
    const element = createElement("c-elaro-copilot", {
      is: ElaroCopilot,
    });
  ...
  describe("Initial Rendering", () => {
    ...
    it("displays the title", async () => {
      ...
      expect(h1.textContent).toBe("Elaro");
    });
  ...
  describe("Error Handling", () => {
    it("handles API errors gracefully", async () => {
      ...
      const copilot = element.shadowRoot.querySelector(".elaro-copilot");
